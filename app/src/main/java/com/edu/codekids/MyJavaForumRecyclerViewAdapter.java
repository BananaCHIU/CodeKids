...
import com.edu.codekids.JavaForumFragment.OnListFragmentInteractionListener;
...
public class MyJavaForumRecyclerViewAdapter extends RecyclerView.Adapter<MyJavaForumRecyclerViewAdapter.ViewHolder> {
    ...
    public MyJavaForumRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
